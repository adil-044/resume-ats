...
import { 
  ...
  Fingerprint, Command, Activity, Terminal
} from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 selection:bg-indigo-500/30 selection:text-indigo-200 overflow-x-hidden font-sans">
      <Navbar />
      ...
      <main className="relative">
        <AuroraBackground className="h-auto py-32 lg:py-48 border-b border-white/5">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-indigo-400 text-[10px] font-black uppercase tracking-[0.4em] mb-8 backdrop-blur-md">
              ...
              <span>Intelligence Standard V12.0</span>
            </div>
            ...
            <h1 className="text-7xl lg:text-[11rem] font-black text-white leading-[0.8] tracking-tighter mb-12 drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]">
              Win the <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/20 uppercase italic tracking-normal">Algorithm.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-8">
              <Link href="/auth/login" className="px-12 py-7 bg-white text-black rounded-3xl font-black text-sm uppercase tracking-widest hover:bg-indigo-500 hover:text-white transition-all shadow-[0_0_50px_-10px_rgba(255,255,255,0.4)] hover:scale-105 active:scale-95">
                Enter Executive Vault
              </Link>
              <a href="#logic" className="px-12 py-7 bg-white/5 text-white border border-white/10 rounded-3xl font-black text-sm uppercase tracking-widest hover:bg-white/10 transition-all backdrop-blur-md">
                Explore The Logic
              </a>
            </div>
          </motion.div>
        ...
        {/* Funnel Section */}
        <section className="py-48 px-6 lg:px-12 relative overflow-hidden">
          ...
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                {[
                  ...
                  <div key={i} className="space-y-3">
                    ...
                    <p className="text-xs text-slate-500 font-bold tracking-tight uppercase">{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="lg:col-span-6 relative">
              <motion.div
                ...
                className="glass-executive p-12 rounded-[4rem] relative overflow-hidden group border-white/10 shadow-2xl"
              >
                ...
                <div className="space-y-12 relative z-10">
                  ...
                  <div className="space-y-6">
                    <div className="relative border-2 border-dashed border-white/10 rounded-[3rem] p-24 text-center group/drop transition-all duration-700 hover:border-indigo-500/50 hover:bg-indigo-500/5 cursor-pointer bg-white/5">
                      <input 
                        type="file" 
                      ...
                      {fileName ? (
                        <div className="flex flex-col items-center">
                          <motion.div initial={{ scale: 0.8 }} animate={{ scale: 1 }} className="bg-indigo-600 p-8 rounded-[2.5rem] mb-6 shadow-2xl shadow-indigo-500/40">
                        ...
                        <div className="flex flex-col items-center">
                          <div className="bg-white/5 p-8 rounded-[2.5rem] mb-6 border border-white/10 group-hover/drop:scale-110 group-hover/drop:bg-indigo-500 transition-all duration-700">
                            <Upload className="h-14 w-14 text-white/20 group-hover/drop:text-white" />
                          </div>
                          <p className="text-white font-black text-2xl tracking-tight uppercase">Upload Source</p>
                          <p className="text-slate-500 text-xs mt-3 font-black uppercase tracking-[0.2em]">PDF / DOCX Required</p>
                        </div>
                      )}
                    </div>
        ...
        <section id="logic" className="py-64 bg-white">
          <div className="max-w-[1600px] mx-auto px-6 lg:px-12 text-center">
            <h2 className="text-7xl lg:text-9xl font-black text-slate-900 tracking-tighter uppercase leading-[0.85] mb-32">
              Executive <br />
        ...
        {showUpsell && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            <motion.div
              ...
              className="relative w-full max-w-[650px] bg-white rounded-[4rem] p-20 shadow-2xl overflow-hidden border border-white/20"
            >
              <div className="text-center relative z-10">
                <div className="bg-indigo-600 w-28 h-24 rounded-[2.5rem] flex items-center justify-center mx-auto mb-12 shadow-2xl ring-8 ring-indigo-50">
                ...
                <p className="text-2xl text-slate-500 font-medium mb-16 leading-relaxed">
                  We've mapped <span className="text-indigo-600 font-black underline decoration-indigo-500/20 text-5xl tracking-tighter italic">12 Critical Gaps</span> in your career architecture.
                </p>
                <div className="space-y-6">
                  <Link href="/auth/login" className="w-full bg-slate-900 text-white py-8 rounded-[2.5rem] font-black text-lg uppercase tracking-widest flex items-center justify-center gap-4 hover:bg-indigo-600 transition-all active:scale-95 group">
                    Unlock Executive Vault <Lock className="h-6 w-6 text-indigo-400 opacity-50" />
                  </Link>
                  <button onClick={() => { setShowUpsell(false); router.push('/auth/login'); }} className="w-full py-6 rounded-[2rem] font-black text-slate-400 hover:text-slate-600 transition-all text-xs uppercase tracking-[0.4em]">
